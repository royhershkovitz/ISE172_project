...
namespace AlgoTrading
{
    public class MarketClientOptions : IMarketClient    {
        ...
        public int SendBuyRequest(int price, int commodity, int amount)
        {
           ...
           string id = client.SendPostRequest(Url, User, token, item);                    
           int num = -1;
          ...
          public MarketClient.DataEntries.IMarketItemQuery SendQueryBuySellRequest(int id)
       {
           ...
           MarketItemQuery response = client.SendPostRequest<Query_request, MarketItemQuery>(Url, User, token, item);           
           return response;          
       }
           ...
           public MarketClient.DataEntries.IMarketUserData SendQueryUserRequest()
       {
           ...
           MarketUserData response = client.SendPostRequest<Query_user, MarketUserData>(Url, User, token, item);           
           return response;           
       }
           ...
           public MarketClient.DataEntries.IMarketCommodityOffer SendQueryMarketRequest(int commodity)
       {
           ...
           MarketCommodityOffer response = client.SendPostRequest<Query_market, MarketCommodityOffer>(Url, User, token, item);           
           return response;          
       }
